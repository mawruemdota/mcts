...
export default function OrderTrackingPage() {
  ...
  const [searchType, setSearchType] = useState('order_number'); // 'order_number' or 'phone'
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      if (orders.length === 0) {
        ...
        const foundOrder = orders[0]; // Get the first matching order
        setOrder(foundOrder);

        // If order has been converted to a job, fetch the job details
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
              ...
              <Card className="shadow-2xl">
                ...
                <CardContent className="bg-slate-50 pt-0 p-6 space-y-6">
          ...
          <div className="flex gap-4 mt-6">
            <a href={createPageUrl('ClientOrderForm')} className="flex-1">
              <Button variant="outline" className="bg-slate-800 px-4 py-2 text-sm font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border border-input shadow-sm hover:bg-accent hover:text-accent-foreground h-9 w-full">
