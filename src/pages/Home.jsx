...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <a href="#services" className="text-gray-700 hover:text-[#2053E6] transition-colors hidden md:block">
                Services
              </a>
              <a href="#contact" className="text-gray-700 hover:text-[#2053E6] transition-colors hidden md:block">
                Contact
              </a>
              <Button onClick={handleLogin} variant="outline" className="border-gray-300 hover:border-[#2053E6] hover:text-[#2053E6]">
                Team Login
              </Button>
              <a href={createPageUrl('ClientOrderForm')}>
                <Button className="bg-[#2053E6] hover:bg-[#1a45c4] text-white">
                  Order Now
                </Button>
              </a>
            </div>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-[#2053E6]/10 text-[#2053E6] border-[#2053E6]/20">
              Our Services
            </Badge>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#2053E6] to-[#1a45c4]">
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="bg-gradient-to-br from-blue-50 to-white border-blue-100 hover:border-[#2053E6]/50 transition-colors">
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-[#2053E6] rounded-full flex items-center justify-center mx-auto mb-4">
                  <Phone className="w-6 h-6 text-white" />
                </div>
                <h4 className="font-semibold text-gray-900 mb-2">Phone</h4>
                <a href="tel:09778270150" className="text-[#2053E6] hover:underline">
                  0977 827 0150
                </a>
              </CardContent>
            </Card>

            <Card className="bg-gradient-to-br from-indigo-50 to-white border-indigo-100 hover:border-[#2053E6]/50 transition-colors">
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-[#2053E6] rounded-full flex items-center justify-center mx-auto mb-4">
                  <Mail className="w-6 h-6 text-white" />
                </div>
                <h4 className="font-semibold text-gray-900 mb-2">Email</h4>
                <a href="mailto:info@mcts.com" className="text-[#2053E6] hover:underline">
                  info@mcts.com
                </a>
              </CardContent>
            </Card>

            <Card className="bg-gradient-to-br from-purple-50 to-white border-purple-100 hover:border-[#2053E6]/50 transition-colors">
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-[#2053E6] rounded-full flex items-center justify-center mx-auto mb-4">
